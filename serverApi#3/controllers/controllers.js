...
exports.addBookToDB = exports.getBooksInPriceRange = exports.getBooksByAuthorName = exports.getBooksBySimpleSearch = exports.getSpecificBook = exports.deleteSpecificBook = exports.getAllBooks = exports.updateBookById = void 0;
...
function updateBookById(req, res, id) {
    return __awaiter(this, void 0, void 0, function () {
        var book, modifiedBook, addedBook, error_8, error_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
